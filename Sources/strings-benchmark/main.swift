...
benchmark("Levenshtein distance", settings: Iterations(500)) {
  ...
  _ = s1.levenshteinDistance(to: s2)
}
...
benchmark("Levenshtein distance random large string", settings: Iterations(100)) {
  _ = string1.levenshteinDistance(to: string2)
}
